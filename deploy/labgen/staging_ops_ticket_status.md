...
> **Current state**: ALL 6 ops tickets VERIFIED; TERMINAL_RUNTIME_HARDENED_WITH_NOTES — coverage 93.21% (3381 tests); 9/9 E2E terminal commands pass (5 allowed + 4 blocked); 3 bugs found+fixed (V1Subject removal, -nkube-system bypass, staging VM auto-cleanup); VM_CLEANUP_EXEMPT_IDS introduced; next: learner validation with kubectl terminal (Labs 2–4 with k8s_test or real learner); see `docs/labgen/TERMINAL_POST_INTEGRATION_RUNTIME_HARDENING_RESULT_v0.1.md`  
